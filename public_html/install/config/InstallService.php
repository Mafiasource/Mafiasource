        ...
        else
        {
            ...
            if(!empty($domain))
            {
                ...
                if(strpos(PROTOCOL . $_SERVER['HTTP_HOST'], $replacedDomain) !== false)
                {
                    ...
                    $htaccessReplacesMap[142] = '    Header always set Content-Security-Policy "default-src 'self'; base-uri 'self'; object-src 'none'; frame-ancestors 'self'; form-action 'self'; img-src 'self' data: https:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://use.fontawesome.com ' . PROTOCOL . 'static.' . $replacedDomain . '; font-src 'self' https://fonts.gstatic.com https://use.fontawesome.com; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.gstatic.com https://www.google.com https://www.paypalobjects.com https://challenges.cloudflare.com ' . PROTOCOL . 'static.' . $replacedDomain . '; frame-src 'self' https://challenges.cloudflare.com; connect-src 'self' ' . PROTOCOL . 'static.' . $replacedDomain . '; upgrade-insecure-requests"';
                }
            }
