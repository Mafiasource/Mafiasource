...
class GetLanguageContent
{
    ...
    public function recoverPasswordLangs()
    {
        ...
        $langs = array(
            ...
            'RECOVER_PASSWORD_EMAIL_MESSAGE' => "Dear {username}<br /><br />We received a request to recover your lost password, if this wassn't you than you can ignore this email.<br /><br />To set a new password you can click or copy the following URL in your address bar: <a href='".PROTOCOL.strtolower($route->settings['domain'])."/recover-password/key/{key}'>".PROTOCOL.strtolower($route->settings['domainBase'])."/recover-password/key/{key}</a><br />After that follow the instructions on your sreen.<br /><br />",
            'RECOVER_PASSWORD_EMAIL_MESSAGE_PRIVATEID' => "A PrivateID is set on your account. If you want to deactivate your PrivateID instead, than you can click or copy the following URL in your address bar: <a href='".PROTOCOL.strtolower($route->settings['domain'])."/recover-password/disable-privateid/{key}'>".PROTOCOL.strtolower($route->settings['domainBase'])."/recover-password/disable-privateid/{key}</a><br /><br />",
            'RECOVER_PASSWORD_EMAIL_FOOTER' => "If you land on a not found page than the above link is expired. You can make a new request on <a href='".PROTOCOL.strtolower($route->settings['domainBase'])."/recover-password'>".PROTOCOL.strtolower($route->settings['domainBase'])."/recover-password</a><br /><br /><br />With kind regards<br />".ucfirst($route->settings['domainBase']),
