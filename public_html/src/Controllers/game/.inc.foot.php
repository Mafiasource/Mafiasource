...
if(strtotime("2023-05-29 14:00:00") < strtotime('now') && strtotime("2023-06-05 14:00:00") > strtotime('now'))
{
    ...
    $twigVars['eventCountdown'] = countdownHmsTime("EventCountdown", strtotime("2023-06-05 14:00:00") - time());
}
...
if(strtotime("2023-05-17 14:00:00") < strtotime('now') && strtotime("2023-05-22 14:00:00") > strtotime('now'))
{
    $twigVars['eventName'] = $twigVars['langs']['WAITING_TIMES'] . " /2";
    $twigVars['eventCountdown'] = countdownHmsTime("EventCountdown", strtotime("2023-05-22 14:00:00") - time());
}
