...
if(strtotime("2023-01-02 14:00:00") < strtotime('now') && strtotime("2023-01-06 14:00:00") > strtotime('now'))
{
    ...
    $twigVars['eventCountdown'] = countdownHmsTime("EventCountdown", strtotime("2023-01-06 14:00:00") - time());
}
...
if(strtotime("2022-12-30 14:00:00") < strtotime('now') && strtotime("2023-01-02 14:00:00") > strtotime('now'))
{
    $twigVars['eventName'] = $twigVars['langs']['WAITING_TIMES'] . " /2";
    $twigVars['eventCountdown'] = countdownHmsTime("EventCountdown", strtotime("2023-01-02 14:00:00") - time());
}
